...
( () => {
    ...
    var e = {
        d: (t, a) => {
            for (var i in a)
                e.o(a, i) && !e.o(t, i) && Object.defineProperty(t, i, {
                    enumerable: !0,
                    get: a[i]
                })
        }
    ...
    const P = globalThis
      , T = P.ShadowRoot && (void 0 === P.ShadyCSS || P.ShadyCSS.nativeShadow) && "adoptedStyleSheets"in Document.prototype && "replace"in CSSStyleSheet.prototype
      , C = Symbol()
      , M = new WeakMap;
    class q {
        constructor(e, t, a) {
    ...
    const H = (e, ...t) => {
      ...
      , I = T ? e => e : e => e instanceof CSSStyleSheet ? (e => {
        let t = "";
        for (const a of e.cssRules)
            t += a.cssText;
        return (e => new q("string" == typeof e ? e : e + "",void 0,C))(t)
    }
    )(e) : e
      , {is: O, defineProperty: L, getOwnPropertyDescriptor: U, getOwnPropertyNames: B, getOwnPropertySymbols: N, getPrototypeOf: Z} = Object
      , F = globalThis
      , V = F.trustedTypes
      , W = V ? V.emptyScript : ""
    ...
    class X extends HTMLElement {
        ...
        static createProperty(e, t=Q) {
            ...
            !t.noAccessor) {
                ...
                void 0 !== i && L(this.prototype, e, i)
            }
        }
        static getPropertyDescriptor(e, t, a) {
            const {get: i, set: o} = U(this.prototype, e) ?? {
                get() {
                    return this[t]
                },
                set(e) {
        ...
        static finalize() {
            ...
            if (this.finalized = !0,
            this._$Ei(),
            this.hasOwnProperty(Y("properties"))) {
        ...
        _$E_() {
            ...
            for (const a of t.keys())
                this.hasOwnProperty(a) && (e.set(a, this[a]),
                delete this[a]);
            e.size > 0 && (this._$Ep = e)
        }
        createRenderRoot() {
            const e = this.shadowRoot ?? this.attachShadow(this.constructor.shadowRootOptions);
            return R(e, this.constructor.elementStyles),
            e
        }
        connectedCallback() {
        ...
        _$ET(e, t) {
            ...
            if (void 0 !== i && !0 === a.reflect) {
                const o = (void 0 !== a.converter?.toAttribute ? a.converter : K).toAttribute(t, a.type);
                this._$Em = e,
        ...
        _$AK(e, t) {
            ...
            if (void 0 !== i && this._$Em !== i) {
                ...
                } : void 0 !== e.converter?.fromAttribute ? e.converter : K;
                this._$Em = i;
                const s = o.fromAttribute(t, e.type);
                this[i] = s ?? this._$Ej?.get(i) ?? s,
                this._$Em = null
            }
        }
        requestUpdate(e, t, a) {
            if (void 0 !== e) {
                const i = this.constructor
                  , o = this[e];
                if (a ??= i.getPropertyOptions(e),
                !((a.hasChanged ?? J)(o, t) || a.useDefault && a.reflect && o === this._$Ej?.get(e) && !this.hasAttribute(i._$Eu(e, a))))
                    return;
                this.C(e, t, a)
            }
        ...
        C(e, t, {useDefault: a, reflect: i, wrapped: o}, s) {
            a && !(this._$Ej ??= new Map).has(e) && (this._$Ej.set(e, s ?? t ?? this[e]),
            !0 !== o || void 0 !== s) || (this._$AL.has(e) || (this.hasUpdated || a || (t = void 0),
            this._$AL.set(e, t)),
            ...
            if (!this.hasUpdated) {
                ...
                if (e.size > 0)
                    for (const [t,a] of e) {
                        const {wrapped: e} = a
                          , i = this[t];
                        !0 !== e || this._$AL.has(t) || void 0 === i || this.C(t, void 0, a, i)
                    }
            }
            let e = !1;
            const t = this._$AL;
    ...
    (F.reactiveElementVersions ??= []).push("2.1.1");
    const ee = globalThis
      , te = ee.trustedTypes
      , ae = te ? te.createPolicy("lit-html", {
        createHTML: e => e
    }) : void 0
      , ie = "$lit$"
      , oe = `lit$${Math.random().toFixed(9).slice(2)}$`
      , se = "?" + oe
      , le = `<${se}>`
      , ne = document
      , re = () => ne.createComment("")
      ...
      , ce = Array.isArray
      , pe = e => ce(e) || "function" == typeof e?.[Symbol.iterator]
      , he = "[ \t\n\f\r]"
      , be = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g
      , ge = /-->/g
      , fe = />/g
      , ue = RegExp(`>|${he}(?:([^\\s"'>=/]+)(${he}*=${he}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g")
      , me = /'/g
      , ve = /"/g
    ...
    Symbol.for("lit-noChange"))
      , Ae = Symbol.for("lit-nothing")
      , $e = new WeakMap
      , _e = ne.createTreeWalker(ne, 129);
    function Se(e, t) {
        if (!ce(e) || !e.hasOwnProperty("raw"))
            throw Error("invalid template strings array");
        return void 0 !== ae ? ae.createHTML(t) : t
    }
    const Ee = (e, t) => {
        const a = e.length - 1
          , i = [];
        let o, s = 2 === t ? "<svg>" : 3 === t ? "<math>" : "", l = be;
        for (let t = 0; t < a; t++) {
            const a = e[t];
            let n, r, d = -1, c = 0;
            for (; c < a.length && (l.lastIndex = c,
            r = l.exec(a),
            null !== r); )
                c = l.lastIndex,
                l === be ? "!--" === r[1] ? l = ge : void 0 !== r[1] ? l = fe : void 0 !== r[2] ? (ye.test(r[2]) && (o = RegExp("</" + r[2], "g")),
                l = ue) : void 0 !== r[3] && (l = ue) : l === ue ? ">" === r[0] ? (l = o ?? be,
                d = -1) : void 0 === r[1] ? d = -2 : (d = l.lastIndex - r[2].length,
                n = r[1],
                l = void 0 === r[3] ? ue : '"' === r[3] ? ve : me) : l === ve || l === me ? l = ue : l === ge || l === fe ? l = be : (l = ue,
                o = void 0);
            const p = l === ue && e[t + 1].startsWith("/>") ? " " : "";
            s += l === be ? a + le : d >= 0 ? (i.push(n),
            a.slice(0, d) + ie + a.slice(d) + oe + p) : a + oe + (-2 === d ? t : p)
        }
        return [Se(e, s + (e[a] || "<?>") + (2 === t ? "</svg>" : 3 === t ? "</math>" : "")), i]
    }
    ;
    class je {
        constructor({strings: e, _$litType$: t}, a) {
            ...
            const l = e.length - 1
              , n = this.parts
              , [r,d] = Ee(e, t);
            if (this.el = je.createElement(r, a),
            _e.currentNode = this.el.content,
            2 === t || 3 === t) {
                const e = this.el.content.firstChild;
                e.replaceWith(...e.childNodes)
            }
            for (; null !== (i = _e.nextNode()) && n.length < l; ) {
                if (1 === i.nodeType) {
                    if (i.hasAttributes())
                        for (const e of i.getAttributeNames())
                            if (e.endsWith(ie)) {
                                const t = d[s++]
                                  , a = i.getAttribute(e).split(oe)
                                  , l = /([.?@])?(.*)/.exec(t);
                                n.push({
                                    type: 1,
                                    index: o,
                                    name: l[2],
                                    strings: a,
                                    ctor: "." === l[1] ? Ce : "?" === l[1] ? Me : "@" === l[1] ? qe : Te
                                }),
                                i.removeAttribute(e)
                            } else
                                e.startsWith(oe) && (n.push({
                                    type: 6,
                                    index: o
                                }),
                                i.removeAttribute(e));
                    if (ye.test(i.tagName)) {
                        const e = i.textContent.split(oe)
                          , t = e.length - 1;
                        if (t > 0) {
    ...
    function De(e, t, a=e, i) {
        if (t === ke)
            return t;
        let o = void 0 !== i ? a._$Co?.[i] : a._$Cl;
        const s = de(t) ? void 0 : t._$litDirective$;
        return o?.constructor !== s && (o?._$AO?.(!1),
        void 0 === s ? o = void 0 : (o = new s(e),
        o._$AT(e, a, i)),
        void 0 !== i ? (a._$Co ??= [])[i] = o : a._$Cl = o),
        void 0 !== o && (t = De(e, o._$AS(e, t.values), o, i)),
        t
    }
    class ze {
        constructor(e, t) {
        ...
        u(e) {
            const {el: {content: t}, parts: a} = this._$AD
              , i = (e?.creationScope ?? ne).importNode(t, !0);
            _e.currentNode = i;
            let o = _e.nextNode()
              , s = 0
              , l = 0
            ...
            for (; void 0 !== n; ) {
                if (s === n.index) {
                    let t;
                    2 === n.type ? t = new Pe(o,o.nextSibling,this,e) : 1 === n.type ? t = new n.ctor(o,n.name,n.strings,this,e) : 6 === n.type && (t = new He(o,this,e)),
                    this._$AV.push(t),
                    n = a[++l]
                }
                s !== n?.index && (o = _e.nextNode(),
                s++)
            }
            return _e.currentNode = ne,
            i
        }
        p(e) {
            let t = 0;
            for (const a of this._$AV)
                void 0 !== a && (void 0 !== a.strings ? (a._$AI(e, a, t),
                t += a.strings.length - 2) : a._$AI(e[t])),
                t++
        }
    }
    class Pe {
        ...
        _$AI(e, t=this) {
            e = De(this, e, t),
            de(e) ? e === Ae || null == e || "" === e ? (this._$AH !== Ae && this._$AR(),
            this._$AH = Ae) : e !== this._$AH && e !== ke && this._(e) : void 0 !== e._$litType$ ? this.$(e) : void 0 !== e.nodeType ? this.T(e) : pe(e) ? this.k(e) : this._(e)
        }
        O(e) {
        ...
        _(e) {
            this._$AH !== Ae && de(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ne.createTextNode(e)),
            this._$AH = e
        }
        $(e) {
            const {values: t, _$litType$: a} = e
              , i = "number" == typeof a ? this._$AC(e) : (void 0 === a.el && (a.el = je.createElement(Se(a.h, a.h[0]), this.options)),
            a);
            if (this._$AH?._$AD === i)
                this._$AH.p(t);
            else {
                const e = new ze(i,this)
                  , a = e.u(this.options);
                e.p(t),
                this.T(a),
                this._$AH = e
        ...
        _$AC(e) {
            ...
            return void 0 === t && $e.set(e.strings, t = new je(e)),
            t
        }
        k(e) {
            ce(this._$AH) || (this._$AH = [],
            this._$AR());
            const t = this._$AH;
            let a, i = 0;
            for (const o of e)
                i === t.length ? t.push(a = new Pe(this.O(re()),this.O(re()),this,this.options)) : a = t[i],
                a._$AI(o),
                i++;
            i < t.length && (this._$AR(a && a._$AB.nextSibling, i),
            t.length = i)
        }
    ...
    class Te {
        ...
        constructor(e, t, a, i, o) {
            ...
            this._$AM = i,
            this.options = o,
            a.length > 2 || "" !== a[0] || "" !== a[1] ? (this._$AH = Array(a.length - 1).fill(new String),
            this.strings = a) : this._$AH = Ae
        }
        _$AI(e, t=this, a, i) {
            ...
            if (void 0 === o)
                ...
                l = 0; l < o.length - 1; l++)
                    n = De(this, i[a + l], t, l),
                    n === ke && (n = this._$AH[l]),
                    s ||= !de(n) || n !== this._$AH[l],
                    n === Ae ? e = Ae : e !== Ae && (e += (n ?? "") + o[l + 1]),
                    this._$AH[l] = n
            }
            s && !i && this.j(e)
        }
    ...
    class qe extends Te {
        ...
        _$AI(e, t=this) {
            if ((e = De(this, e, t, 0) ?? Ae) === ke)
                return;
            const a = this._$AH
              , i = e === Ae && a !== Ae || e.capture !== a.capture || e.once !== a.once || e.passive !== a.passive
              , o = e !== Ae && (a === Ae || i);
    ...
    const Re = ee.litHtmlPolyfillSupport;
    Re?.(je, Pe),
    (ee.litHtmlVersions ??= []).push("3.3.1");
    const Ie = globalThis;
    class Oe extends X {
        constructor() {
            super(...arguments),
        ...
        update(e) {
            ...
            this._$Do = ( (e, t, a) => {
                ...
                if (void 0 === o) {
                    ...
                    i._$litPart$ = o = new Pe(t.insertBefore(re(), e),e,void 0,a ?? {})
                }
                return o._$AI(e),
                o
            }
    ...
    Oe._$litElement$ = !0,
    Oe.finalized = !0,
    Ie.litElementHydrateSupport?.({
        LitElement: Oe
    });
    const Le = Ie.litElementPolyfillSupport;
    Le?.({
        LitElement: Oe
    });
    (Ie.litElementVersions ??= []).push("4.2.1");
    const Ue = (e, t, a) => {
        let i = e[0];
      ...
      , Be = e => {
        return "string" != typeof (t = e) && "strTag"in t ? Ue(e.strings, e.values) : e;
        var t
    }
    ;
    let Ne = Be
    ...
    const We = e => e.addController(new Ve(e));
    class Ge {
        constructor() {
            this.settled = !1,
    ...
    const Ye = [];
    for (let e = 0; e < 256; e++)
        Ye[e] = (e >> 4 & 15).toString(16) + (15 & e).toString(16);
    function Ke(e, t) {
        return (t ? "h" : "s") + function(e) {
            ...
            for (let d = 0; d < e.length; d++)
                ...
                r = n + (s >>> 16) & 65535,
                l = 65535 & s;
            return Ye[r >> 8] + Ye[255 & r] + Ye[l >> 8] + Ye[255 & l] + Ye[o >> 8] + Ye[255 & o] + Ye[a >> 8] + Ye[255 & a]
    ...
    function Xe(e, t, a) {
        if (e) {
            const i = a?.id ?? function(e) {
                const t = "string" == typeof e ? e : e.strings;
                let a = Qe.get(t);
                void 0 === a && (a = Ke(t, "string" != typeof e && !("strTag"in e)),
                Qe.set(t, a));
                return a
            }(t)
              , o = e[i];
            if (o) {
                if ("string" == typeof o)
                    return o;
                if ("strTag"in o)
                    return Ue(o.strings, t.values, o.values);
                {
                    let e = Je.get(o);
                    return void 0 === e && (e = o.values,
                    Je.set(o, e)),
                    {
                        ...o,
    ...
    function et(e) {
        window.dispatchEvent(new CustomEvent(Fe,{
            detail: e
        }))
    }
    let tt, at, it, ot, st, lt = "", nt = new Ge;
    nt.resolve();
    let rt = 0;
    const dt = () => lt
      , ct = e => {
        ...
        if (!it.has(e))
            throw Error("Invalid locale code");
        rt++;
        const t = rt;
        tt = e,
        nt.settled && (nt = new Ge),
        et({
            status: "loading",
            loadingLocale: e
        });
      ...
      , ht = (e=pt, t, a) => {
        ...
        if (void 0 === s && globalThis.litPropertyMetadata.set(o, s = new Map),
    ...
    ;
    function bt(e) {
        return (t, a) => "object" == typeof a ? ht(e, t, a) : ( (e, t, a) => {
            const i = t.hasOwnProperty(a);
            return t.constructor.createProperty(a, e),
            i ? Object.getOwnPropertyDescriptor(t, a) : void 0
        }
        )(e, t, a)
    }
    const gt = ["ar", "bg", "ca-ES", "cs", "da", "de", "el", "es", "fa", "fr", "he", "hu", "it", "ja", "km", "ko", "nl", "no", "pl", "pt", "ru", "sk", "sr", "sv", "tr", "uk", "vi", "zh-CN", "zh-HK"]
      , ft = {
      ...
      , At = {
        ...
        s7f0591f08e318eda: "Appuyez sur Plus dans le menu Partager",
      ...
      , zt = {
        ...
        s7f0591f08e318eda: "Stiskněte Více v menu Sdílet",
      ...
      , Tt = {
        ...
        s7f0591f08e318eda: "Pressione Mais no menu de Compartilhar",
      ...
      , Ct = {
        ...
        s7f0591f08e318eda: "共有メニューで「詳細」を押す",
      ...
      , Ot = {
        ...
        s7f0591f08e318eda: "Nhấn Thêm trong menu Chia sẻ",
      ...
      , Ut = {
        ...
        s7f0591f08e318eda: "Stlačte Viac v menu Zdieľať",
      ...
      , Zt = new Map([["ar", a], ["bg", i], ["ru", o], ["tr", s], ["de", l], ["es", n], ["nl", r], ["el", d], ["fr", c], ["sr", p], ["pl", h], ["uk", b], ["zh-HK", g], ["zh-CN", f], ["it", u], ["cs", m], ["no", v], ["pt", y], ["ja", w], ["sv", x], ["ko", k], ["km", A], ["fa", $], ["da", _], ["vi", S], ["hu", E], ["sk", j], ["ca-ES", D], ["he", z]])
      , {getLocale: Ft, setLocale: Vt} = (Wt = {
        sourceLocale: "en",
        targetLocales: gt,
        loadLocale: async e => Zt.get(e)
    },
    function(e) {
        if (Ze)
            throw Error("lit-localize can only be configured once");
        Ne = e,
        Ze = !0
    }( (e, t) => Xe(st, e, t)),
    lt = at = Wt.sourceLocale,
    it = new Set(Wt.targetLocales),
    it.add(Wt.sourceLocale),
    ot = Wt.loadLocale,
    {
        getLocale: dt,
        setLocale: ct
    ...
    class Jt {
        static isAppleMobile() {
            return !!(navigator.userAgent.match(/Mac/) && navigator.maxTouchPoints && navigator.maxTouchPoints > 2 && "serviceWorker"in navigator)
        }
        static isAppleDesktop() {
            const e = navigator.userAgent.toLowerCase();
            if (navigator.maxTouchPoints || !e.match(/macintosh/))
                return !1;
            const t = /version\/(\d{2})\./.exec(e);
            if (!(t && t[1] && parseInt(t[1]) >= 17))
                return !1;
            const a = !!document.createElement("audio").canPlayType('audio/wav; codecs="1"')
              , i = !!new OffscreenCanvas(1,1).getContext("webgl");
            return a && i
        }
        static isAppleMobileNonSafari() {
            return !(!this.isAppleMobile() || !navigator.userAgent.match(/CriOS|EdgiOS/))
        }
        static isIPad() {
            return !(!navigator.userAgent.match(/iPad|Macintosh/) || !this.isAppleMobile())
        }
        static isApple26Plus() {
            return !!CSS.supports("text-wrap", "pretty")
        }
        static getPageBackgroundColor() {
            const e = window.getComputedStyle(document.body).backgroundColor
              , t = window.getComputedStyle(document.documentElement).backgroundColor;
            return "rgba(0, 0, 0, 0)" !== t ? t : "rgba(0, 0, 0, 0)" !== e ? e : null
        }
        static isAndroid() {
            return !!navigator.userAgent.toLowerCase().match(/android/)
        }
        static isAndroidFallback() {
            return !(!this.isAndroid() || "BeforeInstallPromptEvent"in window)
        }
        static deviceFormFactor() {
        ...
        static async getInstalledRelatedApps() {
            if ("getInstalledRelatedApps"in navigator)
                try {
                    return await navigator.getInstalledRelatedApps().then(e => e)
                } catch (e) {}
            return []
        }
        ...
        static setStorageFlag(e, t, a=!1) {
            try {
                a ? localStorage.setItem(e, t.toString()) : sessionStorage.setItem(e, t.toString())
            } catch (e) {}
        }
        static getStorageFlag(e) {
            try {
                return "true" === sessionStorage.getItem(e) || "true" === localStorage.getItem(e)
            } catch (e) {
                return !1
            }
        }
        static eventInstalledSuccess(e) {
            Kt(e, "pwa-install-success-event", "App install success (Chromium/Android only)")
        }
        static eventInstalledFail(e) {
            Kt(e, "pwa-install-fail-event", "App install failed (Chromium/Android only)")
        }
        static eventUserChoiceResult(e, t) {
            Kt(e, "pwa-user-choice-result-event", t)
        }
        static eventInstallAvailable(e) {
            Kt(e, "pwa-install-available-event", "App install available")
        }
        static eventInstallHowTo(e) {
            Kt(e, "pwa-install-how-to-event", "App install instruction showed")
        }
        static eventGallery(e) {
            Kt(e, "pwa-install-gallery-event", "App install gallery showed")
        }
        ...
        static async fetchAndProcessManifest(e, t, a, i) {
            let o = new Gt
              , s = null;
            try {
                const t = await fetch(e);
                if (s = await t.json(),
                !t.ok || !s || !Object.keys(s))
                    throw Error("Manifest not found");
                this.normalizeManifestAssetUrls(s, e)
            } catch (e) {}
            return t = t || (s?.icons?.length ? s?.icons[0].src : o.icons?.[0].src) || "",
            a = a || (s ? s.short_name : o.short_name) || "",
            i = i || s?.description || o.description || "",
            o = s || o,
            {
                _manifest: o,
                icon: t,
            ...
            <div id="paginated_gallery" class="gallery ${t}">
                <div class="gallery_scroller">
                    <div class="scroller_wrap">
                        ${e.filter(e => !e.form_factor || e.form_factor === Jt.deviceFormFactor()).map(e => xe`<img draggable="false" src='${e.src}' alt='${e.label || ""}'>`)}
                    </div>
                </div>
                <span class="btn prev" @click="${i}">
                    ${"default" != t ? xe`<svg id="arrow-left" viewBox="0 0 23.023 18.518"><path fill="currentColor" d="M0 9.253c0 .305.134.586.378.818l8.106 8.093c.244.232.5.342.793.342.598 0 1.075-.44 1.075-1.05 0-.293-.11-.586-.306-.769l-2.734-2.783-4.834-4.407-.256.598 3.93.244h15.442c.635 0 1.075-.451 1.075-1.086s-.44-1.087-1.075-1.087H6.152l-3.93.245.256.61 4.834-4.419 2.734-2.783a1.09 1.09 0 0 0 .306-.77C10.352.44 9.875 0 9.277 0c-.293 0-.549.098-.818.366L.38 8.436c-.247.23-.38.511-.38.816Z"/></svg>` : xe`<svg id="arrow-left" viewBox="0 0 96 96"><path d="M39.3756,48.0022l30.47-25.39a6.0035,6.0035,0,0,0-7.6878-9.223L26.1563,43.3906a6.0092,6.0092,0,0,0,0,9.2231L62.1578,82.615a6.0035,6.0035,0,0,0,7.6878-9.2231Z" fill="%23999" fill-rule="evenodd"/></svg>`}
                </span>
                <span class="btn next" @click="${a}">
                ${"default" != t ? xe`<svg height="15" width="15">
    ...
    var Xt = function(e, t, a, i) {
        var o, s = arguments.length, l = s < 3 ? t : null === i ? i = Object.getOwnPropertyDescriptor(t, a) : i;
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
            l = Reflect.decorate(e, t, a, i);
        else
            for (var n = e.length - 1; n >= 0; n--)
                (o = e[n]) && (l = (s < 3 ? o(l) : s > 3 ? o(t, a, l) : o(t, a)) || l);
        return s > 3 && l && Object.defineProperty(t, a, l),
        l
    }
      , ea = function(e, t) {
    ...
    class ta extends Oe {
        constructor() {
            ...
            ,
            this.findCurrentItem = (e, t) => {
                const a = e.scrollLeft * (this.rtl ? -1 : 1);
                return t.find(e => e.offsetWidth + e.offsetLeft * (this.rtl ? -1 : 1) >= a + e.offsetWidth / 2.5) || null
            }
            ,
            this.scrollToPage = e => {
                const t = this.getScrollElements();
                if (!t)
                    return;
                const {scroller: a, items: i} = t
                  , o = this.findCurrentItem(a, i);
                if (!o)
                    return;
                const s = i.indexOf(o) + ("next" === e ? 1 : -1) * (this.rtl ? -1 : 1);
                s >= 0 && s < i.length && i[s].scrollIntoView({
                    behavior: "smooth",
                    block: "nearest",
                    inline: "center"
                })
        ...
        firstUpdated() {
            const e = this.getScrollElements();
            e && setTimeout( () => {
                e.scroller.scrollTo({
                    top: 0,
                    left: 0
    ...
    const na = sa(class extends la {
        constructor(e) {
            if (super(e),
            e.type !== oa || "class" !== e.name || e.strings?.length > 2)
        ...
        update(e, [t]) {
            ...
            for (const e in t) {
                const i = !!t[e];
                i === this.st.has(e) || this.nt?.has(e) || (i ? (a.add(e),
                this.st.add(e)) : (a.remove(e),
                this.st.delete(e)))
            }
            return ke
        }
      ...
      , ra = (e, t, a, i, o, s) => xe`
    <div class="dialog-body ${na(( (e=!1, t=!1) => ({
        fallback: e,
        "how-to": t
    }))(o, s))}">
        ...
        <div class="body-header">
            ...
            <button class="material-button primary install" @click='${i}'>
                ...
                <span class="button-text">${Ne("Install")}</span>
            </button>
        </div>
        <div class="how-to-body">
            <div class="description-step">
                ...
                <div class="step-text">${Ne("Open your browser menu")}</div>
            </div>
            <div class="description-step">
                <div class="svg-wrap add-icon">
                    <svg height="24" viewBox="0 -960 960 960" width="24"><path d="M320-40q-33 0-56.5-23.5T240-120v-160h80v40h400v-480H320v40h-80v-160q0-33 23.5-56.5T320-920h400q33 0 56.5 23.5T800-840v720q0 33-23.5 56.5T720-40H320Zm0-120v40h400v-40H320ZM176-280l-56-56 224-224H200v-80h280v280h-80v-144L176-280Zm144-520h400v-40H320v40Zm0 0v-40 40Zm0 640v40-40Z"/></svg>
                </div>
                <div class="step-text">${Ne('Tap "Add to Home screen"')}</div>
            </div>
        </div>
        ${t ? xe`<div class="description">${t}</div>` : ""}
        <slot></slot>
    </div>
    `;
    var da = function(e, t, a, i) {
        var o, s = arguments.length, l = s < 3 ? t : null === i ? i = Object.getOwnPropertyDescriptor(t, a) : i;
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
            l = Reflect.decorate(e, t, a, i);
        else
    ...
    class pa extends Oe {
        constructor() {
            ...
            this.disableClose = !1,
            this.fallback = !1,
            this.howToRequested = !1,
            this.toggleHowTo = {
                handleEvent: () => {}
            },
            this._callInstall = () => {
                if (this.fallback)
                    return this.toggleHowTo.handleEvent(),
                    void setTimeout( () => this.setupAppearence(!0), 210);
            ...
            this.dragMobileSheet = (e, t, a) => {
                if (!e || !t || !a)
                    return null;
                let i = 0;
                const o = a.offsetHeight + a.offsetTop
                  , s = e => e.clientY || (e.changedTouches && e.changedTouches.length ? e.changedTouches[0].clientY : 0)
                  , l = e => {
                  ...
                  , n = t => {
                    if (document.body.style.overscrollBehaviorY = this._saveBodyStyle,
                    !this.disableClose && s(t) >= window.innerHeight - 25)
                        ...
                        try {
                            !this.howToRequested && Jt.eventGallery(this.getRootNode().host)
                        } catch (t) {}
                    } else
                        d(t, window.innerHeight - o - 35)
                }
                  , r = t => {
                    const a = s(t);
                    this.disableClose && window.innerHeight - a < 70 || a <= window.innerHeight - e.clientHeight + i || (e.style.setProperty("transition", "none"),
                  ...
                  , d = (a, i, d) => {
                    ...
                    window.innerWidth >= 768 || (!i && s(a) >= window.innerHeight - o ? e.style.setProperty("--translateY", `translateY(calc(100vh - ${o}px))`) : e.style.setProperty("--translateY", `translateY(${(i || s(a)) + 35}px)`),
                    e.style.setProperty("transition", "transform 500ms cubic-bezier(0.4, 0, 0, 1) 0s"),
                    d && (t.removeEventListener("mousedown", l),
            ...
            ,
            this.setupAppearence = e => {
                this.bindedElement && (this.bindedElement.touchElement.removeEventListener("mousedown", this.bindedElement.listener),
                this.bindedElement.touchElement.removeEventListener("touchstart", this.bindedElement.listener)),
                this.bindedElement = this.dragMobileSheet(this.parentElement, this.shadowRoot?.querySelector(".dialog-body .touch-header"), this.shadowRoot?.querySelector(".dialog-body " + (e ? ".how-to-body" : ".body-header")))
            }
            ,
            this._init = () => {
                this.setupAppearence(),
    ...
    const ha = H`#pwa-install-element{-webkit-user-select:none;user-select:none}#pwa-install-element .install-dialog{--text-color-normal:#212121;--background-color:#fff;--border-bottom-color:#DBDCDE;--scrollbar-background-color:#fff;font-family:Roboto,"Segoe UI",system-ui;position:fixed;display:inline-block;opacity:0;visibility:hidden;z-index:2147483001}#pwa-install-element .install-dialog.chrome{max-width:380px;width:90%;min-height:90px;margin:0 auto;right:150px;left:auto;background-color:var(--background-color);filter:drop-shadow(0 5px 15px rgba(0, 0, 0, .3));font-size:15px;color:var(--text-color-normal);border-radius:8px;top:-100px;transition:top .5s ease-in-out,opacity .8s ease-in-out,max-height .35s ease-in-out}#pwa-install-element .install-dialog.chrome.available{opacity:1;top:28px;visibility:visible}#pwa-install-element .install-dialog.chrome .dialog-body{display:grid;grid-template-columns:70px 1fr}#pwa-install-element .install-dialog.chrome.gallery pwa-gallery{transition:opacity .3s ease-in-out .2s,max-height .5s ease-in-out;max-height:70vh;opacity:1}#pwa-install-element .install-dialog.mobile{--touch-header-color:#DBDCE0;top:0;max-width:414px;width:100%;bottom:auto;left:0;right:0;transition:none;transform:translateY(100vh);border-radius:0;border-top-left-radius:15px;border-top-right-radius:15px;padding-bottom:35px}#pwa-install-element .install-dialog.mobile.available{--translateY:translateY(calc(100vh - 85px));opacity:1;top:0;visibility:visible;transform:var(--translateY)}@media(prefers-color-scheme:dark){#pwa-install-element .install-dialog{--text-color-normal:#eee;--background-color:#1e1e1e;--border-bottom-color:#404140;--scrollbar-background-color:#424242}#pwa-install-element .install-dialog.mobile{--touch-header-color:#3f403f}}@media(max-width:767px)and (min-height:495px){#pwa-install-element .install-dialog.chrome.mobile{display:inline-block}#pwa-install-element .install-dialog.chrome{display:none}}@media(min-width:768px),(max-height:495px){#pwa-install-element .install-dialog.chrome.mobile{display:none}#pwa-install-element .install-dialog.chrome{display:inline-block}}@media(max-height:420px){#pwa-install-element .install-dialog.chrome .dialog-body .description{-webkit-line-clamp:3;max-height:70px}}`
            ...
            <div class="install-dialog chrome ${na(m())}">
                <div class="dialog-body">
                    ...
                    <div class="about">
                        <div class="name">
                            <label>${e}</label>
                            ${s ? "" : xe`<button class="material-button secondary close" @click='${d}'>
                    ...
                    ${t ? xe`<div class="description app-description">${t}</div>` : ""}
                    ${i ? "" : xe`<hr><div class="description install-description">${a || `${Ne("This site has app functionality.")} ${Ne("Install it on your device for extensive experience and easy access.")}`}</div>`}
                    ${v && r ? xe`<pwa-gallery .screenshots=${n.screenshots} .rtl="${u}"></pwa-gallery>` : ""}
                    <div class="action-buttons">
                        ${v ? xe`<button class="material-button secondary" @click='${p}'>${Ne(h ? "Less" : "More")}</button>` : ""}
                        <button class="material-button primary install" @click='${c}'>${Ne("Install")}</button>
                    </div>
                </div>
            </div>
            <div class="install-dialog chrome mobile ${na(m())}">
                <pwa-bottom-sheet .props=${{
            name: e,
            icon: l,
            description: t
        }} .disableClose=${s} .install=${c} .hideDialog=${d} .toggleHowTo=${b} .howToRequested=${g} .fallback=${f}>
                    ${v && r ? xe`<pwa-gallery .screenshots=${n.screenshots} .rtl="${u}"></pwa-gallery>` : ""}
                </pwa-bottom-sheet>
            </div>
        </div>`
      ...
      , fa = "important"
      , ua = " !" + fa
      , ma = sa(class extends la {
        constructor(e) {
            if (super(e),
            e.type !== oa || "style" !== e.name || e.strings?.length > 2)
                throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")
        }
        render(e) {
            return Object.keys(e).reduce( (t, a) => {
                const i = e[a];
                return null == i ? t : t + `${a = a.includes("-") ? a : a.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g, "-$&").toLowerCase()}:${i};`
            }
            , "")
        }
        update(e, [t]) {
            ...
            for (const e of this.ft)
                ...
                e.includes("-") ? a.removeProperty(e) : a[e] = null);
            for (const e in t) {
                const i = t[e];
                if (null != i) {
                    this.ft.add(e);
                    const t = "string" == typeof i && i.endsWith(ua);
                    e.includes("-") || t ? a.setProperty(e, t ? i.slice(0, -11) : i, t ? fa : "") : a[e] = i
                }
            }
            return ke
        }
      ...
      , va = (e, t, a, i, o, s, l=!1, n, r, d, c, p, h, b, g, f=!1, u=!1, m=!1, v={}) => {
        const y = !o && r.screenshots && r.screenshots.length;
        let w = {
            "--tint-color": Jt.getPageBackgroundColor(),
            ...v
        };
        return xe`
        <aside id="pwa-install-element" dir="${f ? "rtl" : "ltr"}">
            <article class="install-dialog apple ${na({
            available: d,
            aqua: u,
            "how-to": h,
            "how-to-manual": l,
            ...
            "apple-mobile": !m
                ...
                ${s ? "" : xe`<button type="button" title="close" class="close" @click='${c}' ontouchstart="">
                    <svg viewBox="0 0 24 24"><path d="M5.3 18.7c.2.2.4.3.7.3s.5-.1.7-.3l5.3-5.3 5.3 5.3a1.08 1.08 0 0 0 .7.3 1.08 1.08 0 0 0 .7-.3c.4-.4.4-1 0-1.4L13.4 12l5.3-5.3c.4-.4.4-1 0-1.4s-1-.4-1.4 0L12 10.6 6.7 5.3c-.4-.4-1-.4-1.4 0s-.4 1 0 1.4l5.3 5.3-5.3 5.3c-.4.4-.4 1 0 1.4z"/></svg>
                </button>`}
                ${i ? "" : xe`<div class="welcome-to-install">
                    ${a || `${Ne("This site has app functionality.")} ${Ne(m ? "Add it to your Dock for extensive experience and easy access." : "Add it to your Home Screen for extensive experience and easy access.")}`}</div>`}
                <div class="how-to-body">
                    <div class="how-to-description">
                        ...
                        <div class="description-step">
                            ...
                            <div class="step-text">${Ne("Open in your main browser")}</div>
                        </div>`}
                        ${m || Jt.isAppleMobileNonSafari() || Jt.isIPad() || !u ? "" : xe`
                        <div class="description-step">
                            <div class="svg-wrap">
                            ...
                            <div class="step-text">${Ne("Press More if no Share icon")}</div>
                        </div>`}
                        <div class="description-step">
                            <div class="svg-wrap">
                            ...
                            <div class="step-text">${Ne("Press Share in Navigation bar")}</div>
                        </div>
                        ${!m && Jt.isIPad() ? xe`
                        <div class="description-step">
                            <div class="svg-wrap">
                            ...
                            <div class="step-text">${Ne("Press More in Share menu")}</div>
                        </div>` : ""}
                        <div class="description-step">
                            <div class="svg-wrap">
                                ${m ? xe`<svg id="pwa-add" viewBox="0 0 23.389 17.979" width="25" height="25">
                                    ...
                                    </svg>` : xe`<svg id="pwa-add" width="25" height="25">
                            ...
                            <div class="step-text">${Ne(m ? "Press Add to Dock" : 'Scroll down to "Add to Home Screen"')}</div>
                        </div>
                    </div>
                </div>
                ${y && d ? xe`<pwa-gallery .screenshots=${r.screenshots} .theme="${m ? "apple_desktop" : "apple_mobile"}" .rtl="${f}"></pwa-gallery>` : ""}
                <div class="action-buttons">
                    ${y ? xe`<button class="dialog-button button gallery" @click=${b} ontouchstart="">
                    <span class="button-text">
                            ${g ? xe`<span>${Ne("Back")}</span>
                    ...
                    <button class="dialog-button button install" @click=${p} ontouchstart="">
                        ...
                        <span class="button-text ${h ? "hide" : "show"}">
                            <span>${Ne(m ? "Add to Dock" : "Add to Home Screen")}</span>
    ...
    let xa = class extends Oe {
        constructor() {
            ...
            this.install = () => {
                this.isAppleMobilePlatform || this.isAppleDesktopPlatform ? (this._howToRequested = !0,
                this.requestUpdate()) : this._install.handleEvent()
            }
            ,
            this._hideDialog = {
                handleEvent: () => {
                    this.isDialogHidden = !0,
                    Jt.setStorageFlag("pwa-hide-install", !0, this.useLocalStorage),
                    this.requestUpdate()
                }
                ,
                passive: !0
            ...
            this._hideDialogUser = () => {
                Jt.eventUserChoiceResult(this, "dismissed"),
            ...
            this.showDialog = (e=!1) => {
                ...
                Jt.setStorageFlag("pwa-hide-install", !1, this.useLocalStorage),
                this.requestUpdate()
            }
            ,
            this.getInstalledRelatedApps = async () => await Jt.getInstalledRelatedApps(),
            this._toggleHowTo = {
                handleEvent: () => {
                    this._howToRequested = !this._howToRequested,
                    this._howToRequested && this._galleryRequested && (this._galleryRequested = !1),
                    this.requestUpdate(),
                    this._howToRequested && Jt.eventInstallHowTo(this)
                }
                ,
                passive: !0
            },
            this._toggleGallery = {
                handleEvent: () => {
                    ...
                    this._howToRequested && this._galleryRequested && (this._howToRequested = !1),
                    this._galleryRequested && Jt.eventGallery(this),
                    this.requestUpdate()
                }
                ,
                passive: !0
            ...
            this._init = async () => {
                ...
                "onappinstalled"in window && window.addEventListener("appinstalled", e => {
                    window.defferedPromptEvent = null,
                    this.isInstallAvailable = !1,
                    this.requestUpdate(),
                    Jt.eventInstalledSuccess(this)
                }
                ),
                Object.assign(this, await Jt.fetchAndProcessManifest(this.manifestUrl, this.icon, this.name, this.description))
            }
            ,
            this._requestUpdate = () => {
                this.requestUpdate()
        ...
        async _checkPlatform() {
            this.isUnderStandaloneMode = Jt.isStandalone(),
            this.isRelatedAppsInstalled = await Jt.isRelatedAppsInstalled(),
            this.isAppleMobilePlatform = Jt.isAppleMobile(),
            this.isAppleDesktopPlatform = Jt.isAppleDesktop(),
            this.isApple26Plus = Jt.isApple26Plus() && (this.isAppleMobilePlatform || this.isAppleDesktopPlatform),
            this.isAndroidFallback = Jt.isAndroidFallback(),
            this.isAndroid = Jt.isAndroid()
        }
        async _triggerAppleDialog() {
            setTimeout( () => {
                this.isInstallAvailable = !0,
                this.requestUpdate(),
                Jt.eventInstallAvailable(this)
            }
            , 500)
        }
        async _checkInstallAvailable() {
            if (this.isUnderStandaloneMode)
                return;
            if (this.isAppleMobilePlatform || this.isAppleDesktopPlatform)
                return this.manualApple && this.hideDialog(),
                void ("complete" === document.readyState ? await this._triggerAppleDialog() : window.addEventListener("load", async () => {
            ...
            if (!this.disableChrome && window.BeforeInstallPromptEvent) {
                ...
                const t = t => {
                    window.defferedPromptEvent = t,
                    t.preventDefault(),
                    this.platforms = t.platforms,
                    this.isRelatedAppsInstalled ? this.isInstallAvailable = !1 : (this.isInstallAvailable = !0,
                    Jt.eventInstallAvailable(this)),
                    "accepted" === this.userChoiceResult && (this.isDialogHidden = !0,
                    Jt.eventInstalledSuccess(this)),
                    e = !0,
                    this.isAndroidFallback = !1,
                    this.requestUpdate()
                ...
                ;
                null != this.externalPromptEvent ? setTimeout( () => t(this.externalPromptEvent), 300) : window.addEventListener("beforeinstallprompt", t)
            }
            if (!this.disableFallback && this.isAndroid && !e) {
                ...
                if ("userActivation"in navigator && !this.isRelatedAppsInstalled) {
                    const t = navigator.userActivation
                      , a = setInterval( () => {
                        (t.isActive || t.hasBeenActive) && (e || (this.isAndroidFallback = !0,
                        this.isInstallAvailable = !0,
                        this.requestUpdate(),
                        Jt.eventInstallAvailable(this)),
                        clearInterval(a))
                    ...
                    , 1e3);
                    setTimeout( () => clearInterval(a), 3e4)
                }
            }
        }
        async connectedCallback() {
            await (async e => {
                ...
                try {
                    Zt.get(e) ? await Vt(e) : await Vt(e.slice(0, 2))
                } catch {}
            }
            )(navigator.language),
            this._isRTL = ( () => {
        ...
        render() {
            return this.isAppleMobilePlatform || this.isAppleDesktopPlatform ? xe`${va(this.name, this.description, this.installDescription, this.disableDescription, this.disableScreenshots || this.disableScreenshotsApple, this.disableClose, this.manualHowTo, this.icon, this._manifest, this.isInstallAvailable && !this.isDialogHidden, this._hideDialogUser, this._toggleHowTo, this._howToRequested || this.manualHowTo, this._toggleGallery, this._galleryRequested, this._isRTL, this.isApple26Plus, this.isAppleDesktopPlatform, this.styles)}` : xe`${ga(this.name, this.description, this.installDescription, this.disableDescription, this.disableScreenshots || this.disableScreenshotsChrome, this.disableClose, this.icon, this._manifest, this.isInstallAvailable && !this.isDialogHidden, this._hideDialogUser, this._install, this._toggleGallery, this._galleryRequested, this._toggleHowTo, this._howToRequested, this.isAndroidFallback, this._isRTL)}`
        }
    }
    ;
    ya([bt({
        attribute: "manifest-url"
    }), wa("design:type", Object)], xa.prototype, "manifestUrl", void 0),
    ya([bt(), wa("design:type", Object)], xa.prototype, "icon", void 0),
    ya([bt(), wa("design:type", Object)], xa.prototype, "name", void 0),
    ya([bt(), wa("design:type", Object)], xa.prototype, "description", void 0),
    ya([bt({
        attribute: "install-description"
    }), wa("design:type", Object)], xa.prototype, "installDescription", void 0),
    ya([bt({
        attribute: "disable-install-description",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "disableDescription", void 0),
    ya([bt({
        attribute: "disable-screenshots",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "disableScreenshots", void 0),
    ya([bt({
        attribute: "disable-screenshots-apple",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "disableScreenshotsApple", void 0),
    ya([bt({
        attribute: "disable-screenshots-chrome",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "disableScreenshotsChrome", void 0),
    ya([bt({
        attribute: "manual-apple",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "manualApple", void 0),
    ya([bt({
        attribute: "manual-chrome",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "manualChrome", void 0),
    ya([bt({
        attribute: "manual-how-to",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "manualHowTo", void 0),
    ya([bt({
        attribute: "disable-chrome",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "disableChrome", void 0),
    ya([bt({
        attribute: "disable-close",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "disableClose", void 0),
    ya([bt({
        attribute: "disable-android-fallback",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "disableFallback", void 0),
    ya([bt({
        attribute: "use-local-storage",
        type: Boolean
    }), wa("design:type", Object)], xa.prototype, "useLocalStorage", void 0),
    ya([bt({
        attribute: "styles",
        type: Object
    }), wa("design:type", Object)], xa.prototype, "styles", void 0),
    ya([function(e) {
        return bt({
            ...e,
            state: !0,
    ...
    }(), wa("design:type", Object)], xa.prototype, "externalPromptEvent", void 0),
    xa = ya([ (e, t) => (e.addInitializer(We),
    e)], xa),
    customElements.get("pwa-install") || customElements.define("pwa-install", xa),
...
//# sourceMappingURL=pwa-install.bundle.js.map
  ...
  let savedThisRoll = false;
  let lastSavedKey = '';
  let lockedDisplayColors = null;
  ...
  const stableDelay = 120;
  const forceSaveDelay = 500;
  const finishDelay = 80;

  // ====================================
  // HELPERS
  // ====================================

  function ignoreMutations(ms = 12) {
    ignoreMutationsUntil = Date.now() + ms;
  }

  function getActiveExcludedColors() {
    return isRolling
      ? activeRollExcludedColors
      : excludedColors;
  }
  ...
  function getColor(el) {
    ...
    if (inline && allColors.includes(inline)) {
      return inline;
    }

    const computed =
      normalizeColor(getComputedStyle(el).color);

    return rgbToName[computed] || '';
  }

  function applyColor(el, color) {
    if (!el || !color) return;

    if (getColor(el) === color) return;
  ...
  function getDiceCount() {
    const select =
      ...
      [...document.querySelectorAll('select')]
        .find(s =>
          s.innerText &&
          s.innerText.toLowerCase().includes('dice')
        );
  ...
  function loadExcluded() {
    try {
      excludedColors =
        JSON.parse(
          localStorage.getItem('abc_excluded')
        ) || [];
    } catch {
      excludedColors = [];
    }
  ...
  function loadHistory() {
    try {
      abcHistory =
        JSON.parse(
          localStorage.getItem('abc_history')
        ) || [];
    } catch {
      abcHistory = [];
    }
  ...
  function pickAllowed(displayColors = []) {
    const activeExcluded =
      getActiveExcludedColors();

    let allowed =
      allColors.filter(c =>
        !activeExcluded.includes(c)
      );
    ...
    let saferAllowed =
      allowed.filter(color =>
        (counts[color] || 0) < 2
      );

    if (!saferAllowed.length) {
      saferAllowed = allowed;
    }

    return saferAllowed[
      Math.floor(
        Math.random() * saferAllowed.length
      )
    ];
  }

  function pickReplacement(originalColors, displayColors = []) {
    const activeExcluded =
      getActiveExcludedColors();
    ...
    if (!allowed.length) {
      allowed =
        allColors.filter(c =>
          !activeExcluded.includes(c) &&
          displayColors.filter(x => x === c).length < 2
        );
    }
  ...
  function getHistoryContainer() {
    ...
    return card
      ? card.querySelector('.section-text')
      : null;
  }

  function makeRow(colors, index) {
    const row =
  ...
  function getDiceIcons() {
    ...
    let icons =
      [...tabletop.querySelectorAll('i[class*="df-solid"]')];
    ...
    if (
      diceCount > 0 &&
      diceCount <= 6 &&
      icons.length > diceCount
    ) {
      icons =
        icons.slice(-diceCount);
    }
  ...
  function buildDisplayColors(icons) {
    const originalColors = [];
    const displayColors = [];
    console.log('[RESULT VISIBLE]', Date.now());
    ...
    icons.forEach((el) => {
      ...
      if (
        !realColor ||
        !allColors.includes(realColor)
      ) {
        realColor =
          pickAllowed(displayColors);
      }

      originalColors.push(realColor);

      let finalColor =
        realColor;

      if (
        activeRollExcludedColors.length &&
        activeRollExcludedColors.includes(realColor)
      ) {
        finalColor =
          pickReplacement(
            originalColors,
      ...
      displayColors.push(finalColor);
    });

    return displayColors;
  }

  function processDice(finalize = false) {
    const icons =
      getDiceIcons();
    ...
    if (!icons.length || !diceCount) {
      return [];
    }

   if (
  !lockedDisplayColors ||
  lockedDisplayColors.length !== icons.length
) {
  lockedDisplayColors =
    buildDisplayColors(icons);

  if (
    isRolling &&
    !savedThisRoll &&
    lockedDisplayColors.length
  ) {
    savedThisRoll = true;

    addHistory(lockedDisplayColors);
    ...
    icons.forEach((el, index) => {
      applyColor(el, displayColors[index]);
    });
  ...
  function checkDice(finalize = false) {
    if (processing) {
      if (finalize) {
  ...
  function setSingleExcludedColor(color) {
    ...
    window.addEventListener(
      ...
      event => {
        ...
        groupIndex[key] =
          ...
          keyGroups[key].length;

        const color =
          keyGroups[key][groupIndex[key]];

        setSingleExcludedColor(color);
      }
    );
  }
